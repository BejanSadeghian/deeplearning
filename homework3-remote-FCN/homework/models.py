...
#        
#        self.conv_1 = torch.nn.Conv2d(n_input_channels, 32, kernel_size=3, padding=11, stride=1)
...
#        
#        self.convtr_1 = torch.nn.ConvTranspose2d(128, 128, kernel_size=3, stride=2, padding=1)
#        self.convtr_2 = torch.nn.ConvTranspose2d(128, 128, kernel_size=3, stride=2, padding=1)
#
...
#        
#        self.bnormtr_1 = torch.nn.BatchNorm2d(128)
#        
...
#        
#        t_1 = self.bnormtr_1(self.convtr_1(a_7))
#        t_1 = self.convtr_2(t_1)
#
#        z = self.classifier(t_1)
#        return z
