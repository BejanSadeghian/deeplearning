...
class FCN(torch.nn.Module):
    ...
    def __init__(self, layers=[32,64,128], n_input_channels=3, kernel_size=7):
        ...
        self.conv_6 = torch.nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)
        self.conv_7 = torch.nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)
        self.conv_8 = torch.nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)

        self.convtr_8 = torch.nn.ConvTranspose2d(256,256, kernel_size=3, stride=1, padding=1, output_padding=0)
        self.convtr_7 = torch.nn.ConvTranspose2d(256*2,256, kernel_size=3, stride=1, padding=1, output_padding=0)
        self.convtr_6 = torch.nn.ConvTranspose2d(256*2,256, kernel_size=3, stride=1, padding=1, output_padding=0)
        ...
        self.bnorm_7 = torch.nn.BatchNorm2d(256)
        self.bnorm_8 = torch.nn.BatchNorm2d(256)
        ...
        self.res_6 = torch.nn.Conv2d(256, 256, kernel_size=1, stride=1)
        self.res_7 = torch.nn.Conv2d(256, 256, kernel_size=1, stride=1)
        self.res_8 = torch.nn.Conv2d(256, 256, kernel_size=1, stride=1)
...
#        z = self.net(x)
        ...
        z_7 = self.conv_7(a_6)
        a_7 = self.relu(self.bnorm_7(z_7)) + self.res_7(a_6)
        z_8 = self.conv_8(a_7)
        a_8 = self.relu(self.bnorm_8(z_8)) + self.res_8(a_7)

        d_8 = self.relu(self.convtr_8(a_8))
