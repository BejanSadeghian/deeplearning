        ...
        try:
            ...
            for n in range(1, n_steps+1):
                ...
                if (n % (batch_size) == 0 and n != 0):
                    ...
                    l = loss(kart[1:], puck[1:], log_probabilities[1:])
                    print('loss',l)
                    ...
                    #Titrate up on training so you dont get stuck in a goal every epoch
                    # Every 10 epochs allow one more batch starting at 1
                    if n / batch_size >= allowed_batchs and False:
                        break
